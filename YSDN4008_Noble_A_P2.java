...
public class YSDN4008_Noble_A_P2 extends PApplet {
...
PShape info;
 ...
 // importing the ControlP5 library
...
public void setup() {
    ...
    cp5 = new ControlP5(this); // initialize the cp5 variable
              ...
              cp5.addToggle("transit")
                     ...
                     .setSize(20,20)
                     .setColorActive(color(0xff92d4ec, 255))
                     .setColorForeground(color(0xff92d4ec, 255))
                     .setColorBackground(color(0xff92d4ec, 70))
              ...
              cp5.addToggle("radialVelocity")
                     ...
                     .setSize(20,20)
                     .setColorActive(color(0xff8425fd, 255))
                     .setColorForeground(color(0xff8425fd, 255))
                     .setColorBackground(color(0xff8425fd, 70))
                     // .setFont(myFont)
                     .setLabelVisible(false) 
                     ;
              ...
              cp5.addToggle("imaging")
                     .setPosition(width/2 + 60,670)
                     .setSize(20,20)
                     .setColorActive(color(0xfffd9f25, 255))
                     .setColorForeground(color(0xfffd9f25, 255))
                     .setColorBackground(color(0xfffd9f25, 50))
                     .setLabelVisible(false) 
                     ;
              ...
              cp5.addToggle("other")
                     .setPosition(width/2 + 190,670)
                     .setSize(20,20)
                     .setColorActive(color(0xffb8fd25, 255))
                     .setColorForeground(color(0xffb8fd25, 255))
                     .setColorBackground(color(0xffb8fd25, 50))
                     .setLabelVisible(false) 
                     ;
...
public void draw() {
  ...
  for(int row = 0; row < rowCount; row ++) {
            ...
            // Mapping 
                  distance = PApplet.parseInt(map(distance, 0, 10000, 10, 1400));
                  radius = PApplet.parseInt(map(radius, 0, 500, 5, 200));
...
public void controlEvent(ControlEvent theControlEvent) {
      if(theControlEvent.isFrom("year")) {
            min = PApplet.parseInt(theControlEvent.getController().getArrayValue(0));
            max = PApplet.parseInt(theControlEvent.getController().getArrayValue(1));
             // println(min + "  " + max);
      } 
}
  ...
  public void settings() {  size(1200, 730);  smooth(); }
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "YSDN4008_Noble_A_P2" };
    if (passedArgs != null) {
